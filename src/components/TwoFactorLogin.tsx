    ...
    <Card className="w-full max-w-md mx-auto">
      <CardHeader>
        ...
        <CardDescription className="text-center">
          <TranslatedText text="Enter the verification code sent to your email" />
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-gray-600 text-center">
            <TranslatedText text="Enter the 6-digit code from your email" />
          </p>
        </div>
        ...
        <div className="space-y-2">
          <Button
            ...
            className="w-full"
          >
            <TranslatedText text={state.isLoading ? 'Verifying...' : 'Verify Code'} />
          </Button>
